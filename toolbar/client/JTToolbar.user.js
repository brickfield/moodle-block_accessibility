...
var toolbarItems = {
		...
		TTS: { id: 'tts', ico: 'sound.png', act: 'ttsOptions()', tip: 'Text to Speech options', clickEnabled: true, positition: "", playingItem: "",
				dialogs: {
					...
					starting: "<h2>Text To Speech</h2> <center>Text to Speech conversion is taking place. <br /><img src='" + settings.baseURL + "/presentation/images/loadingbig.gif' /><br />Time remaining: <div id='sbttstimeremaining'>calculating</div><br />Please wait... </center>"
				},
				extendedButtons: {
