...
(function(jQuery) {
  ...
  jQuery.extend(jQuery.facebox, {
    settings: {
      opacity      : 0,
      overlay      : true,
      loadingImage : 'http://access.ecs.soton.ac.uk/seb/StudyBar/presentation/images/loading.gif',
      closeImage   : 'http://access.ecs.soton.ac.uk/seb/StudyBar/presentation/images/closelabel.gif',
          ...
          <tbody> \
            ...
            <tr> \
              ...
              <td class="body"> \
                ...
                <div class="footer"> \
                  <a href="#" class="close"> \
                    <img src="http://access.ecs.soton.ac.uk/seb/StudyBar/presentation/images/closelabel.gif" title="close" class="close_image" /> \
                  </a> \
                </div> \
              </td> \
              <td class="b"/> \
  ...
  function init(settings) {
	...
	jQuery('#sbar').after(jQuery.facebox.settings.faceboxHtml)
